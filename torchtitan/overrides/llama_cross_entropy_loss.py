...
"""Override ChunkedCELoss with plain CrossEntropyLoss.
...
@override(
    ...
    target=ChunkedCELoss.Config,
    fqns=["loss"],
    description="Use plain CrossEntropyLoss instead of ChunkedCELoss.",
)
def llama_cross_entropy_loss(
    cfg: ChunkedCELoss.Config,
